...
v1_to_v3_system_prompt = [
    "**Objective**",
    "Migrate the airflow v1 dag into v3 dag. Use the following links as reference for grounding.",
    "REFERENCE: https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/operators.html",
    "REFERENCE: https://airflow.apache.org/docs/apache-airflow/stable/installation/upgrading_to_airflow3.html" 
]